...
public class literature_DeThi_2018_21 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras.containsKey("literature_DeThi_2018"))
        {
        ...
        if (extras_2019.containsKey("literature_DeThi_2019"))
        {
        ...
        if (extras_2020.containsKey("literature_DeThi_2020"))
        {
        ...
        if (extras_2021.containsKey("literature_DeThi_2021"))
        {
