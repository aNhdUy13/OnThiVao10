...
public class fragment_english_result extends Fragment {
    TextView txtCard1, txtCard2, txtCard3, txtCard4,txtDeThi2018,
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        txtDeThi2018   = (TextView) view.findViewById(R.id.txt_topic_5);
        txtDeThi2019   = (TextView) view.findViewById(R.id.txt_topic_main_card_6);
        txtDeThi2020   = (TextView) view.findViewById(R.id.txt_topic_main_card_7);
