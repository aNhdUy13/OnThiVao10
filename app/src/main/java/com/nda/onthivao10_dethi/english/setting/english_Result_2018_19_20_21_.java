...
public class english_Result_2018_19_20_21_ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras3.containsKey("english_2020_result"))
        {
        ...
        if (extras4.containsKey("english_2021_result"))
        {
    ...
    private void showCard_2021() {
        ...
        txt_src1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                extras.putBoolean("hcm_english_2021_result", true);
                in.putExtras(extras);
                startActivity(in);
            }
        });
        ...
        txt_src2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Bundle extras = new Bundle();
                extras.putBoolean("danang_english_2021_result", true);
                in.putExtras(extras);
                startActivity(in);
            }
        });
        txt_src3.setText("Hà Nội ");
        txt_src3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(getApplicationContext(), HN_dapan.class);
                Bundle extras = new Bundle();
                extras.putBoolean("hn_english_2021_result", true);
                in.putExtras(extras);
                startActivity(in);
            }
        });
    ...
    private void showCard_2020() {
        ...
        txt_src1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in = new Intent(getApplicationContext(), HCM_dapan.class);
                Bundle extras = new Bundle();
                extras.putBoolean("hcm_english_2020_result", true);
                in.putExtras(extras);
                startActivity(in);
            }
        });
        ...
        txt_src2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in = new Intent(getApplicationContext(), DaNang_dapan.class);
                Bundle extras = new Bundle();
                extras.putBoolean("danang_english_2020_result", true);
                in.putExtras(extras);
                startActivity(in);
            }
        });
