...
public class math_result_from_43_78 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapting();
        /* Display result from topic 22 => 40 */
        ...
        Bitmap bitmap_rs_1 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_43);
        imgMathResult_40_from_1_42_src1.setImageBitmap(bitmap_rs_1);

        Bitmap bitmap_rs_2 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_44);
        imgMathResult_40_from_1_42_src2.setImageBitmap(bitmap_rs_2);

        Bitmap bitmap_rs_3 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_45);
        imgMathResult_40_from_1_42_src3.setImageBitmap(bitmap_rs_3);

        Bitmap bitmap_rs_4 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_46);
        imgMathResult_40_from_1_42_src4.setImageBitmap(bitmap_rs_4);

        Bitmap bitmap_rs_5 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_47);
        imgMathResult_40_from_1_42_src5.setImageBitmap(bitmap_rs_5);

        Bitmap bitmap_rs_6 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_48);
        imgMathResult_40_from_1_42_src6.setImageBitmap(bitmap_rs_6);

        Bitmap bitmap_rs_7 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_49);
        imgMathResult_40_from_1_42_src7.setImageBitmap(bitmap_rs_7);

        Bitmap bitmap_rs_8 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_50);
        imgMathResult_40_from_1_42_src8.setImageBitmap(bitmap_rs_8);

        Bitmap bitmap_rs_9 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_51);
        imgMathResult_40_from_1_42_src9.setImageBitmap(bitmap_rs_9);

        Bitmap bitmap_rs_10 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_52);
        imgMathResult_40_from_1_42_src10.setImageBitmap(bitmap_rs_10);

        Bitmap bitmap_rs_11 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_53);
        imgMathResult_40_from_1_42_src11.setImageBitmap(bitmap_rs_11);

        Bitmap bitmap_rs_12 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_54);
        imgMathResult_40_from_1_42_src12.setImageBitmap(bitmap_rs_12);

        Bitmap bitmap_rs_13 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_55);
        imgMathResult_40_from_1_42_src13.setImageBitmap(bitmap_rs_13);

        Bitmap bitmap_rs_14 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_56);
        imgMathResult_40_from_1_42_src14.setImageBitmap(bitmap_rs_14);

        Bitmap bitmap_rs_15 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_57);
        imgMathResult_40_from_1_42_src15.setImageBitmap(bitmap_rs_15);

        Bitmap bitmap_rs_16 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_58);
        imgMathResult_40_from_1_42_src16.setImageBitmap(bitmap_rs_16);

        Bitmap bitmap_rs_17 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_59);
        imgMathResult_40_from_1_42_src17.setImageBitmap(bitmap_rs_17);

        Bitmap bitmap_rs_18 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_60);
        imgMathResult_40_from_1_42_src18.setImageBitmap(bitmap_rs_18);

        Bitmap bitmap_rs_19 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_61);
        imgMathResult_40_from_1_42_src19.setImageBitmap(bitmap_rs_19);

        Bitmap bitmap_rs_20 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_62);
        imgMathResult_40_from_1_42_src20.setImageBitmap(bitmap_rs_20);

        Bitmap bitmap_rs_21 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_63);
        imgMathResult_40_from_1_42_src21.setImageBitmap(bitmap_rs_21);

        Bitmap bitmap_rs_22 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_64);
        imgMathResult_40_from_1_42_src22.setImageBitmap(bitmap_rs_22);

        Bitmap bitmap_rs_23 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_65);
        imgMathResult_40_from_1_42_src23.setImageBitmap(bitmap_rs_23);

        Bitmap bitmap_rs_24 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_66);
        imgMathResult_40_from_1_42_src24.setImageBitmap(bitmap_rs_24);

        Bitmap bitmap_rs_25 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_67);
        imgMathResult_40_from_1_42_src25.setImageBitmap(bitmap_rs_25);

        Bitmap bitmap_rs_26 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_68);
        imgMathResult_40_from_1_42_src26.setImageBitmap(bitmap_rs_26);

        Bitmap bitmap_rs_27 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_69);
        imgMathResult_40_from_1_42_src27.setImageBitmap(bitmap_rs_27);

        Bitmap bitmap_rs_28 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_70);
        imgMathResult_40_from_1_42_src28.setImageBitmap(bitmap_rs_28);

        Bitmap bitmap_rs_29 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_71);
        imgMathResult_40_from_1_42_src29.setImageBitmap(bitmap_rs_29);

        Bitmap bitmap_rs_30 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_72);
        imgMathResult_40_from_1_42_src30.setImageBitmap(bitmap_rs_30);

        Bitmap bitmap_rs_31 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_73);
        imgMathResult_40_from_1_42_src31.setImageBitmap(bitmap_rs_31);

        Bitmap bitmap_rs_32 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_74);
        imgMathResult_40_from_1_42_src32.setImageBitmap(bitmap_rs_32);

        Bitmap bitmap_rs_33 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_75);
        imgMathResult_40_from_1_42_src33.setImageBitmap(bitmap_rs_33);

        Bitmap bitmap_rs_34 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_76);
        imgMathResult_40_from_1_42_src34.setImageBitmap(bitmap_rs_34);

        Bitmap bitmap_rs_35 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_77);
        imgMathResult_40_from_1_42_src35.setImageBitmap(bitmap_rs_35);

        Bitmap bitmap_rs_36 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_77);
        imgMathResult_40_from_1_42_src36.setImageBitmap(bitmap_rs_36);

        Bitmap bitmap_rs_37 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_result_78);
