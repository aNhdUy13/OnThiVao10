...
public class KienGiang_de extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras_2018.containsKey("kiengiang_math_detail_2018")) {
        ...
        if (extras_2019.containsKey("kiengiang_math_detail_2019")) {
    ...
    private void from_2019() {
        ...
        img_src_1.setImageBitmap(bitmap);
        Bitmap bitmap2 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_kiengiang_2019_tp2);
        img_src_2.setImageBitmap(bitmap2);
        Bitmap bitmap3 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_kiengiang_2019_tp3);
        img_src_3.setImageBitmap(bitmap3);
    ...
    {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.mipmap.math_kiengiang_2018_tp1);
        img_src_1.setImageBitmap(bitmap);
