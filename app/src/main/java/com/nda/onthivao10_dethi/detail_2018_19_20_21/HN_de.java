...
public class HN_de extends AppCompatActivity {
    ...
    private void literature_from2021() {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.mipmap.literature_hn_2021_tp1);
    ...
    private void literature_from2020() {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.mipmap.literature_hn_2020_tp1);
        img_src_1.setImageBitmap(bitmap);
    ...
    private void literature_from2019() {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.mipmap.literature_hn_2019_tp1);
        img_src_1.setImageBitmap(bitmap);
    ...
    private void literature_from2018() {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.mipmap.literature_hn_2018_tp1);
        img_src_1.setImageBitmap(bitmap);
