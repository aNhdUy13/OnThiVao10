...
public class HN_dapan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras_2018.containsKey("HN_RSmath_detail_2018")) {
        ...
        if (extras_2019.containsKey("HN_RSmath_detail_2019")) {
        ...
        if (extras_2020.containsKey("HN_RSmath_detail_2020")) {
        ...
        if (history_extras_2021.containsKey("hanoi_history_2021_result")) {
        ...
        if (english_extras_2019.containsKey("hn_english_2019_result")) {
        ...
        if (literature_extras_2018.containsKey("HN_literature_detail_2018")) {
        ...
        if (literature_extras_2019.containsKey("HN_literature_detail_2019")) {
        ...
        if (literature_extras_2020.containsKey("HN_literature_detail_2020")) {
        ...
        if (literature_extras_2021.containsKey("HN_literature_detail_2021")) {
    ...
    private void literature_from2021() {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.mipmap.literature_hn_2021_rs1);
    ...
    private void literature_from2020() {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.mipmap.literature_hn_2020_rs1);
        img_src_1.setImageBitmap(bitmap);

        Bitmap bitmap2 = BitmapFactory.decodeResource(getResources(),R.mipmap.literature_hn_2020_rs2);
    ...
    private void literature_from2019() {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.mipmap.literature_hn_2019_rs1);
        img_src_1.setImageBitmap(bitmap);
    ...
    private void literature_from2018() {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.mipmap.literature_hn_2018_rs1);
        img_src_1.setImageBitmap(bitmap);
    ...
    {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.mipmap.english_2019_hn_rs1);
        img_src_1.setImageBitmap(bitmap);
    ...
    private void history_2021() {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.mipmap.history_hanoi_2021_rs1);
        img_src_1.setImageBitmap(bitmap);
    ...
    private void from2020()
    {
        ...
        Bitmap bitmap2 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_hanoi_2020_rs1);
        img_src_2.setImageBitmap(bitmap2);

        Bitmap bitmap3 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_hanoi_2020_rs1);
    ...
    {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.mipmap.math_hn_2019_rs1);
        img_src_1.setImageBitmap(bitmap);

        Bitmap bitmap2 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_hn_2019_rs2);
        img_src_2.setImageBitmap(bitmap2);

        Bitmap bitmap3 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_hn_2019_rs3);
        img_src_3.setImageBitmap(bitmap3);

        Bitmap bitmap4 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_hn_2019_rs4);
    ...
    {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.mipmap.math_hn_2018_rs1);
        img_src_1.setImageBitmap(bitmap);

        Bitmap bitmap2 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_hn_2018_rs2);
        img_src_2.setImageBitmap(bitmap2);

        Bitmap bitmap3 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_hn_2018_rs3);
        img_src_3.setImageBitmap(bitmap3);

        Bitmap bitmap4 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_hn_2018_rs4);
        img_src_4.setImageBitmap(bitmap4);
