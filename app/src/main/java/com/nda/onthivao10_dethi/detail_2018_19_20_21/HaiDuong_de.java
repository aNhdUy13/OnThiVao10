...
public class HaiDuong_de extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras_2018.containsKey("HaiDuong_math_detail_2018")) {
            txtMain_title.setText("Đề Thi Toán Vào 10 Năm 2018\n - Hải Dương -");
            from2018();
        }
        in_2019 = getIntent();
        extras_2019 = in_2019.getExtras();
        if (extras_2019.containsKey("HaiDuong_math_detail_2019")) {
    ...
    {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.mipmap.math_haiduong_2019_tp1);
        img_src_1.setImageBitmap(bitmap);
    ...
    {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.mipmap.math_haiduong_2018_tp1);
        img_src_1.setImageBitmap(bitmap);
