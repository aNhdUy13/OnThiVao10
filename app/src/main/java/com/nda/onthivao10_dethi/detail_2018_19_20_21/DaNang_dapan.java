...
public class DaNang_dapan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (english_extras_2019.containsKey("danang_english_2019_result")) {
    ...
    {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.mipmap.english_danang_2019_rs1);
        img_src_1.setImageBitmap(bitmap);

        Bitmap bitmap2 = BitmapFactory.decodeResource(getResources(),R.mipmap.english_danang_2019_rs2);
        img_src_2.setImageBitmap(bitmap2);
