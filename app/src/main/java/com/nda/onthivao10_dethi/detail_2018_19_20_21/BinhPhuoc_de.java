...
public class BinhPhuoc_de extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras_2018.containsKey("BinhPhuoc_math_detail_2018")) {
        ...
        if (extras_2019.containsKey("BinhPhuoc_math_detail_2019")) {
        ...
        if (extras_2020.containsKey("BinhPhuoc_math_detail_2020")) {
    ...
    {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.mipmap.math_binhphuoc_2020_tp1);
    ...
    {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.mipmap.math_binhphuong_2019_tp1);
        img_src_1.setImageBitmap(bitmap);

        Bitmap bitmap2 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_binhphuong_2019_tp2);
    ...
    {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.mipmap.binhphuoc_2018_topic_math);
        img_src_1.setImageBitmap(bitmap);
