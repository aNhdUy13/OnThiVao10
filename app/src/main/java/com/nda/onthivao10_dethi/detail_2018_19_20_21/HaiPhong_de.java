...
public class HaiPhong_de extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras_2018.containsKey("HaiPhong_math_detail_2018")) {
        ...
        if (extras_2019.containsKey("HaiPhong_math_detail_2019")) {
        ...
        if (extras_2020.containsKey("HaiPhong_math_detail_2020")) {
    ...
    {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.mipmap.math_haiphong_2020_tp1);
        img_src_1.setImageBitmap(bitmap);

        Bitmap bitmap2 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_haiphong_2020_tp2);
    ...
    {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.mipmap.math_haiphong_2019_tp1);
        img_src_1.setImageBitmap(bitmap);

        Bitmap bitmap2 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_haiphong_2019_tp2);
        img_src_2.setImageBitmap(bitmap2);
    ...
    {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.mipmap.math_haiphong_2018_tp1);
        img_src_1.setImageBitmap(bitmap);

        Bitmap bitmap2 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_haiphong_2018_tp2);
        img_src_2.setImageBitmap(bitmap2);
