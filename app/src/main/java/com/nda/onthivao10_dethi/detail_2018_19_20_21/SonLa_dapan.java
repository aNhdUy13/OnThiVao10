...
public class SonLa_dapan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras_2018.containsKey("sonla_RSmath_detail_2018"))
        {
        ...
        if (extras_2019.containsKey("sonla_RSmath_detail_2019")) {
    ...
    {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.mipmap.math_sonla_2019_rs1);
        img_src_1.setImageBitmap(bitmap);

        Bitmap bitmap2 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_sonla_2019_rs2);
        img_src_2.setImageBitmap(bitmap2);

        Bitmap bitmap3 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_sonla_2019_rs3);
        img_src_3.setImageBitmap(bitmap3);

        Bitmap bitmap4 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_sonla_2019_rs4);
        img_src_4.setImageBitmap(bitmap4);

        Bitmap bitmap5 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_sonla_2019_rs5);
    ...
    {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.mipmap.math_sonla_2018_rs1);
        img_src_1.setImageBitmap(bitmap);

        Bitmap bitmap2 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_sonla_2018_rs2);
        img_src_2.setImageBitmap(bitmap2);

        Bitmap bitmap3 = BitmapFactory.decodeResource(getResources(),R.mipmap.math_sonla_2018_rs3);
        img_src_3.setImageBitmap(bitmap3);
