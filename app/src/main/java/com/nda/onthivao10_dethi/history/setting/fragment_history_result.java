...
import com.nda.onthivao10_dethi.history.history_DapAn_2021;
import com.nda.onthivao10_dethi.history.history_DeThi_2021;
import com.nda.onthivao10_dethi.history.outside_dethi.history_practice_result;
import com.nda.onthivao10_dethi.math.math_DeThi_2018_19_20_21;

public class fragment_history_result extends Fragment {
    TextView txtCard1, txtCard2, txtCard3, txtCard4,txtCard5,txtCard6,txtCard7,
            txtDeThi2021;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        txtDeThi2021.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(getContext(), history_DapAn_2021.class);
                Bundle extras = new Bundle();
                extras.putBoolean("history_dapan_2021", true);
                in.putExtras(extras);
                startActivity(in);
            }
        });
